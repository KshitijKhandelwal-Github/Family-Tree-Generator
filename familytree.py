...
ancestry = pd.read_csv('family.csv')
earl_ans = ancestry.loc[ancestry['Relation'] == 'Earliest Ancestor', 'Person1'].iloc[0]
...
for i in range(0, max_iter):
    ...
    if len(temp) == 0:      # Break loop when all individuals have been recorded
        ...
        temp=temp.copy().reset_index()
        temp.loc[temp['Person2'].isin(incomp), 'this_gen_ind'] = 1
